...
package protocol APIProtocol: Sendable {
    ...
    func messages_post(_ input: Operations.messages_post.Input) async throws -> Operations.messages_post.Output
}
...
extension APIProtocol {
    ...
    package func messages_post(
        ...
        try await messages_post(Operations.messages_post.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    package enum Schemas {
        ...
        package struct ErrorResponse: Codable, Hashable, Sendable {
            ...
            @frozen package enum errorPayload: Codable, Hashable, Sendable {
                ...
                package func encode(to encoder: any Swift.Encoder) throws {
                    switch self {
                    case let .api_error(value):
                        try value.encode(to: encoder)
                    case let .authentication_error(value):
                        try value.encode(to: encoder)
                    case let .invalid_request_error(value):
                        try value.encode(to: encoder)
                    case let .not_found_error(value):
                        try value.encode(to: encoder)
                    case let .overloaded_error(value):
                        try value.encode(to: encoder)
                    case let .permission_error(value):
                        try value.encode(to: encoder)
                    case let .rate_limit_error(value):
                        try value.encode(to: encoder)
                    }
                }
            }
            ...
            package struct contentPayload: Codable, Hashable, Sendable {
                ...
                @frozen package enum Value2PayloadPayload: Codable, Hashable, Sendable {
                    ...
                    package func encode(to encoder: any Swift.Encoder) throws {
                        ...
                        case let .text(value):
                            try value.encode(to: encoder)
                        case let .tool_result(value):
                            try value.encode(to: encoder)
                        case let .tool_use(value):
                            try value.encode(to: encoder)
                        }
                    }
                }
                /// - Remark: Generated from `#/components/schemas/InputMessage/content/value2`.
                package typealias Value2Payload = [Components.Schemas.InputMessage.contentPayload.Value2PayloadPayload]
                /// - Remark: Generated from `#/components/schemas/InputMessage/content/value2`.
        ...
        package struct RequestToolResultBlock: Codable, Hashable, Sendable {
            ...
            package struct contentPayload: Codable, Hashable, Sendable {
                ...
                package typealias Value2Payload = [Components.Schemas.RequestToolResultBlock.contentPayload.Value2PayloadPayload]
                /// - Remark: Generated from `#/components/schemas/RequestToolResultBlock/content/value2`.
    ...
    package enum messages_post {
        ...
        package struct Input: Sendable, Hashable {
            ...
            package struct Headers: Sendable, Hashable {
                ...
                package var accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.messages_post.AcceptableContentType>]
                ...
                package init(
                    ...
                    accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.messages_post.AcceptableContentType>] = .defaultValues()
                ) {
