...
@Suite internal struct ErrorHandlingTests {
  ...
  internal func testErrorHandlingExample() throws {
    ...
    let normalizedGenerated = generated.replacingOccurrences(of: " ", with: "").replacingOccurrences(of: "\n", with: "")
    let normalizedExpected = expected.replacingOccurrences(of: " ", with: "").replacingOccurrences(of: "\n", with: "")
